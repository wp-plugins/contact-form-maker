  ...
  <table cellspacing="10" width="95%">
    <tr>
      ...
      <td style="width:90px; text-align:right;"><input class="button-secondary action" type="button" value="Add a Form"
                                                       ...
                                                       onclick="window.location.href='admin.php?page=contact_form&task=add_form'"/>
      </td>
      <?php if ($old_version) { ?>
      <td style="width:90px; text-align:right;"><input class="button-primary action" type="button" value=" Update Forms"
                                                       name="update_forms"
                                                       onclick="window.location.href='admin.php?page=contact_form&task=update'"/>
      </td><?php }?>
  ...
  <table class="wp-list-table widefat fixed pages" style="width:95%">
    ...
    <tr>
      ...
      <td><?php if (!$old_version) { ?><a
        href="admin.php?page=contact_form&task=edit_form&id=<?php echo $rows[$i]->id?>"><?php echo $rows[$i]->id; ?></a><?php }
      else { ?>   <p style="color:red; cursor:pointer; margin:0px"
                     onclick="alert('Update forms to new version!')"><?php echo $rows[$i]->id; ?></p><?php }?></td>
      <td><?php if (!$old_version) { ?><a
        href="admin.php?page=contact_form&task=edit_form&id=<?php echo $rows[$i]->id?>"><?php echo $rows[$i]->title; ?></a><?php }
      else { ?>   <p style="color:red; cursor:pointer; margin:0px"
                     onclick="alert('Update forms to new version!')"><?php echo $rows[$i]->title; ?></p><?php }?></td>
      <td><?php echo $rows[$i]->mail; ?></td>
      <td><?php if (!$old_version) { ?><a
        href="admin.php?page=contact_form&task=edit_form&id=<?php echo $rows[$i]->id?>">Edit</a><?php }
      else { ?>   <p style="color:red; cursor:pointer; margin:0px" onclick="alert('Update forms to new version!')">
        Edit</p><?php }?></td>
      <td><a
        href="javascript:confirmation('admin.php?page=contact_form&task=remove_form&id=<?php echo $rows[$i]->id?>','<?php echo $rows[$i]->title; ?>')">Delete</a>
      </td>
    </tr>
      <?php } ?>
    </tbody>
...
<table width="95%">
  ...
  <tr>
    ...
    <td align="right"><input type="button" onclick="window.location.href='admin.php?page=contact_form'" value="Cancel"
                             class="button-secondary action"/></td>
  </tr>
</table>
<br/>
...
<div id="formMakerDiv1" align="center">
  <table border="0" width="95%" cellpadding="0" cellspacing="0" height="100%" style="border:6px #00aeef solid; background-color:#FFF">    <tr>
              ...
              <table border="0" cellpadding="0" cellspacing="3" width="100%">
                ...
                <tr>
                  <td align="center"
                      ...
                      id="table_time_and_date" style="background-color: rgb(114, 113, 113) !important;"
                  ...
                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      id="table_select" style="background-color: rgb(114, 113, 113) !important;" class="field_buttons">
                    <img src="<?php echo plugins_url("images/select.png", __FILE__); ?>" style="margin:5px"
                         id="img_select"/></td>
                </tr>
                <tr>
                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      id="table_checkbox" style="background-color: rgb(114, 113, 113) !important;"
                      class="field_buttons"><img src="<?php echo plugins_url("images/checkbox.png", __FILE__); ?>"
                                                 style="margin:5px" id="img_checkbox"/></td>

                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      id="table_radio" style="background-color: rgb(114, 113, 113) !important;" class="field_buttons">
                    <img src="<?php echo plugins_url("images/radio.png", __FILE__); ?>" style="margin:5px"
                         id="img_radio"/></td>
                </tr>
                <tr>
                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      id="table_file_upload" style="background-color: rgb(114, 113, 113) !important;"
                ...
                <tr>
                  <td align="center" onClick="addRow('map')" id="table_map" class="field_buttons"><img
...
<div id="<?php echo user_can_richedit() ? 'postdivrich' : 'postdiv'; ?>"
     class="postarea"><?php the_editor("", "contact_form_editor", "title", $media_buttons = TRUE, $tab_index = 1, $extended = TRUE); ?>
</div>
        <?php }
      else {
        echo "<style>#wp-contact_form_editor-media-buttons{ text-align:left }</style>";
        wp_editor("", "contact_form_editor");
      } ?>
</div>
<?php
    }
      ...
      ?>
      <textarea name="editor" id="editor" cols="40" rows="6" style="width: 450px; height: 350px; " class="mce_editable"
...
<div id="formMakerDiv1" style="padding-top:20px" align="center">
            ...
            <td width="15%" height="100%" style="border-right:dotted black 1px;" id="field_types">
              ...
              <table border="0" cellpadding="0" cellspacing="3" width="100%">
                ...
                <tr>
                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      style="cursor:pointer; background-color: rgb(114, 113, 113) !important;" id="table_time_and_date"
                      class="field_buttons"><img src="<?php echo plugins_url("images/time_and_date.png", __FILE__) ?>"
                                                 style="margin:5px" id="img_time_and_date"/></td>

                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      style="cursor:pointer; background-color: rgb(114, 113, 113) !important;" id="table_select"
                ...
                <tr>
                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      style="cursor:pointer; background-color: rgb(114, 113, 113) !important;" id="table_checkbox"
                      class="field_buttons"><img src="<?php echo plugins_url("images/checkbox.png", __FILE__) ?>"
                                                 style="margin:5px" id="img_checkbox"/></td>

                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      style="cursor:pointer; background-color: rgb(114, 113, 113) !important;" id="table_radio"
                ...
                <tr>
                  <td align="center"
                      onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')"
                      style="cursor:pointer; background-color: rgb(114, 113, 113) !important;" id="table_file_upload"
                      class="field_buttons"><img src="<?php echo plugins_url("images/file_upload.png", __FILE__); ?>"
                                                 style="margin:5px" id="img_file_upload"/></td>
                ...
                <tr>
                  <td align="center" onClick="addRow('map')" style="cursor:pointer" id="table_map"
                      class="field_buttons"><img src="<?php echo plugins_url("images/map.png", __FILE__) ?>"
                                                 style="margin:5px" id="img_map"/></td>
                  <td align="center" onClick="alert('This field type is disabled in free version. If you need this functionality, you need to buy the commercial version.')" style="cursor:pointer; background-color: rgb(114, 113, 113) !important;" id="table_paypal" class="field_buttons">
  ...
  <div id="main_editor"
    ...
    ?>
    <textarea name="contact_form_editor" id="contact_form_editor" cols="40" rows="6"
              style="width: 440px; height: 350px; " class="mce_editable" aria-hidden="true"></textarea>
    <?php
  }
    ?></div>
</div>
...
function html_form_options($row, $themes) {
  ...
  <form action="admin.php?page=contact_form&id=<?php echo $row->id; ?>" id="adminForm" method="post" name="adminForm">
    ...
    <table width="97%">
      <tbody>
        <tr>
          <td style="margin:5px;float:right" align="right"><input type="button" onclick="window.location.href='admin.php?page=contact_form&task=edit_form&id=<?php echo $row->id; ?>'" value="Cancel" class="button-secondary action"> </td>
